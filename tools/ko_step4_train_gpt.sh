...
TRAIN_MANIFEST="${TRAIN_MANIFEST:-/mnt/sdb1/emilia-yodas/KO_preprocessed/gpt_pairs_train.jsonl::ko}"
VAL_MANIFEST="${VAL_MANIFEST:-/mnt/sdb1/emilia-yodas/KO_preprocessed/gpt_pairs_val_subset.jsonl::ko}"
...
CONFIG_PATH="${CONFIG_PATH:-/mnt/sda1/models/index-tts-ko/checkpoints/config.yaml}"
